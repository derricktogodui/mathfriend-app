...
def load_css():
    ...
    <style>
        ...
        /* --- NEW: DARK MODE TEXT FIX --- */
        /* This is the crucial rule that fixes the invisible text in dark mode. */
        /* It forces text in the main content area to be dark, even in dark mode. */
        [data-baseweb="theme-dark"] div[data-testid="stAppViewContainer"] * {
            color: #31333F !important;
        }
        
        /* This part re-applies the light text color for the sidebar in dark mode */
