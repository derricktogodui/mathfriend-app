...
def generate_question(topic):
    ...
    generator_func = generators.get(topic, lambda: {"question": f"Questions for **{topic}** coming soon!", "options": ["OK"], "answer": "OK", "hint": "Select another topic."})
...
def load_css():
    ...
    <style>
        ...
        .login-container {
            background: var(--card-background-color); border-radius: 16px; padding: 2rem 3rem;
            margin: auto; max-width: 450px; box-shadow: 0 8px 32px rgba(0,0,0,0.1);
        }
